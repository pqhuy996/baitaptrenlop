public class LibaryItem {
    ...
    static class Book extends LibaryItem {
        ...
        public String getDetails() {
            return "Book[title: " + title + ", year published: " + yearPublished + ", author: " + author + ", isbn: " + isbn + "]";
        }
    }
    static class Magazine extends LibaryItem {
        ...
        public String getDetails() {
            return "Megazine[title: " + title + ", year published: " + yearPublished + ", issueNumber: " + issueNumber + ", publisher: " + publisher + "]";
        }
    }
}